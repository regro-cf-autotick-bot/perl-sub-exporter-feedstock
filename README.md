...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/perl-sub-exporter-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/perl-sub-exporter-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add perl-sub-exporter
# for installing globally
pixi global install perl-sub-exporter
```
...
It is possible to list all of the versions of `perl-sub-exporter` available on your platform:
...
```
pixi search perl-sub-exporter --channel conda-forge
```
